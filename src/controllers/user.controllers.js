...
const generateAccessAndRefreshTokens = async userId => {
    try {
        ...
        new ApiError(500, "Something went wrong while generating Access and Refresh Tokens")
    }
}
const registerUser = asyncHandler(async (req, res) => {
    ...
    // upload image to cloudinary, check for successful upload
    // create user object - create entry in db
    // remove password and refresh token from the mongodb response
